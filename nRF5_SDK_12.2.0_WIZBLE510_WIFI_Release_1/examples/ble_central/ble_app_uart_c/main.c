...
extern wizfi310_state_t Wizfi310_state;
extern wizfi310_flag_t wizfi310_flag;
...
void uart_event_handle(app_uart_evt_t * p_event)
{
    ...
    switch (p_event->evt_type)
    {
        ...
        case APP_UART_DATA_READY:
            ...
            if (wizfi310_flag.con_flag == false)
            {
            ...
            else
            {
              ...
              {
                if (strstr((char *)data_array, "[DISCONNECT") != NULL)
                {
                  wizfi310_flag.con_flag = false;
                  Wizfi310_state = WIZFI310_EXIT_DATAMODE;
                }
                else 
                {
        ...
        case BLE_GAP_EVT_ADV_REPORT:
        {
            ...
            if (is_uuid_present(&m_nus_uuid, p_adv_report))
            {
                ...
                if (err_code == NRF_SUCCESS)
                {
                    ...
                    APP_ERROR_CHECK(err_code);
                    printf(0, "Connecting to target %02x%02x%02x%02x%02x%02x\r\n",
    ...
    const app_uart_comm_params_t comm_params =
      {
        ...
        .rts_pin_no   = 0xFF, //RTS_PIN_NUMBER,
        .cts_pin_no   = 0xFF, //CTS_PIN_NUMBER,
...
int main(void)
{
    ...
    nus_c_init();
    Wizfi310_state = WIZFI310_EXIT_DATAMODE;
    wizfi310_timers_init();
    wizfi310_timers_start();
